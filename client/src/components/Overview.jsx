...
export default function Overview({ days = 90 }) {
        ...
        {loading ? (
          ...
          <>
            ...
            <KPICard
              ...
              sub={`vs $${data.baselineAOV.toFixed(2)} baseline · ${aovLift}% higher`}
              delta={parseFloat(aovLift)}
              icon={ShoppingBag}
              accent="#f59e0b"
              delay={240}
            />
          ...
          <>
            {[
              ...
              },
              {
                ...
                pct: Math.min(100, Math.round(parseFloat(aovLift))),
              },
            ].map((item, i) => (
